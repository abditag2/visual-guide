 ...
 * Return Type  : void
 */
void sobel_initialize(emlrtContext *aContext)
{
 ...
 * Return Type  : void
 */
void sobel_api(const mxArray *prhs[2], const mxArray *plhs[1])
{
...
/*
 * File trailer for _coder_sobel_api.c
 *
 * [EOF]
 */
