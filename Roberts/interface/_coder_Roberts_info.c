...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]//ad.uillinois.edu/engr/Instructional/dshi9/documents/MATLAB/coderdemo_edge_detection/coderdemo_edge_detection/coderdemo_edge"
    "_detection/Roberts.m"), "context", 0);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]//ad.uillinois.edu/engr/Instructional/dshi9/documents/MATLAB/coderdemo_edge_detection/coderdemo_edge_detection/coderdemo_edge"
    "_detection/Roberts.m"), "context", 8);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]//ad.uillinois.edu/engr/Instructional/dshi9/documents/MATLAB/coderdemo_edge_detection/coderdemo_edge_detection/coderdemo_edge"
    "_detection/Roberts.m"), "context", 16);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]//ad.uillinois.edu/engr/Instructional/dshi9/documents/MATLAB/coderdemo_edge_detection/coderdemo_edge_detection/coderdemo_edge"
    "_detection/Roberts.m"), "context", 19);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("Roberts"));
...
/*
 * File trailer for _coder_Roberts_info.c
 *
 * [EOF]
 */
