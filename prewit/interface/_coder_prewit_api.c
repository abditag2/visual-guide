 ...
 * Return Type  : void
 */
void prewit_initialize(emlrtContext *aContext)
{
 ...
 * Return Type  : void
 */
void prewit_api(const mxArray *prhs[2], const mxArray *plhs[1])
{
  ...
  prewit(originalImage, threshold, edgeImage);
...
/*
 * File trailer for _coder_prewit_api.c
 *
 * [EOF]
 */
